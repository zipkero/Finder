window.__define_resource && __define_resource("LBL93099","MSG01136","LBL03634","BTN00575","LBL00165","LBL03682","MSG00706","LBL02253","LBL02186","BTN00054","LBL05309","LBL05396");
/****************************************************************************************************
1. Create Date : 2016-09-29.
2. Creator     : Luong Ngoc Hoang
3. Description : Acct. I > Voucher > Print Payment Journal
4. Precaution  :  
...
6. Old file    : EBG/EBG012M.aspx?RptGubun=1 
****************************************************************************************************/
ecount.page.factory("ecount.page.list.search.account", "EBG012M", {
    ...
    initPageDefaultData: function () {
        ...
        this.pageInfo = {
            type: "account",                                // 전표타입
            path: "/ECERP/EBG/EBG012M",                     // 페이지 URL        
            formTypeCode: "AR040",                          // 리스트 양식타입(grid form type)         AR080             
            formTypeSearch: "AM561",                        // 검색조건 양식타입(search form type)            
            title: ecount.resource.LBL93099,                // 페이지 타이틀            
        ...
        this.gridInfo = function (param) {
            ...
            return {
                ...
                api: [{ path: "/Inventory/Purchases/GetListPrintPaymentJournal" }],
    ...
    onInitFooter: function (footer) {
        ...
        toolbar.addLeft(ctrl.define("widget.button.group", "Print").label(ecount.resource.LBL00165).addGroup(addgroup));
        ...
        switch (control.id) {
            case "acct_no_f":
                addParam = {
                    ...
                    strInputFlag: 'N',
                    PageGubun: 'Y',
                    isCommonFlag: false  //no use param in common
                }
                break;
    ...
    openPrintPopup: function (printData, actionCode) {
        ...
        if (printData == null) {
            ...
            selectedItems = this.contents.getGrid().getCheckedItem();
        ...
        var url = "";
        if (printData == null) {
            // when clicked then print buttons on footer (khi nút được click là nút in ở bên dưới footer)
        ...
        if (this.finalSearchParam.BEFORE_FLAG != "0" && this.finalSearchParam.BEFORE_FLAG != undefined)
            data["cbBeforeFlag"] = "1"
        else
            data["cbBeforeFlag"] = "";
        ...
        data["M_TrxSer"] = "";
        data["M_EditFlag"] = "M";
        data["M_RptGubun"] = this.strBeforeFlag == "AFTER" ? "26" : "51"; // Y => "26" , N => "51"
        data["M_FocusX"] = "0";
        data["M_FocusY"] = "0";
        data["M_SerNo"] = "1";
        data["M_TrxDate"] = "";
        ...
        var popupDataPrint = {
            ...
            height: 600,
            Request: {
                FORM_TYPE: actionCode == "1" ? "AF040" : "AF020",
                FORM_SEQ: 0,
                Slips: slips,
                Data: {
                    SITE: "",
