...
{
    /// <summary title="EBA070P_03Action">
    /// 1. Create Date	: 2020.03.09
    /// 2. Creator		: Lê Đặng Hoàng Linh
    /// 3. Description	: EBA070P_03Action
    /// 4. Precaution	: 
    ...
    public class EBA070P_03Action : ERPXHttpViewActionBase<EBA070P_03Action, Data.RequestBase.ERPXViewListAccountRequest<EBA070P_03Request>>
    {
        public EBA070P_03Action() { }
        ...
        protected override PipeResult<HttpActionResult> ExecuteCore(IERPSessionContext context)
        {
            ...
            return CreatePipeResult(() => this.DefaultView("~/View.Account/EBA/Views/XEBA070P_03.js"));
        }
        ...
        /// Generator
        /// </summary>
        public class ViewBagGenerator : ERPViewBagGenerator<EBA070P_03Action>
        {
            public ViewBagGenerator()
            {
                ...
                MappingFor(m => m.CacheInfo, dest => {
                    dest.Assign("defaultForm", (mo, ctx) => {
                        ...
                        defaultForm.Add(ECUtil.JoinString("_", "C", "MR762", 1));
                        return defaultForm;
                    });
                });
                #endregion
                ...
                MappingFor(m => m.Permission, dest => {
                    ...
                    dest.Assign("AccountPermit", (mo, ctx) => ctx.Permission[ERPProgramId.Account.ChartofAccounts]);
                });
                #endregion
        ...
        /// validator
        /// </summary>
        public class Validator : Validator<EBA070P_03Action, IERPSessionContext>
        {
            public Validator()
            {
            }
    ...
    public class EBA070P_03Request
    {
